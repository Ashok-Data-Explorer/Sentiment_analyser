...
st.sidebar.image(rounded_image, caption="Ashok.c", width=150)

# Display creator's name and new description
st.sidebar.subheader("Ashok")
st.sidebar.write("""
Hi, I'm Ashok, and I'm excited to introduce the Sentiment Analysis feature of this application. 
...
st.sidebar.markdown("""
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue)](https://www.linkedin.com/in/ashok-chinnamarla-a10294266)  
[![GitHub](https://img.shields.io/badge/GitHub-Follow-black)](https://github.com/Ashok-Data-Explorer)  
[![Email](https://img.shields.io/badge/Email-Contact-red)](mailto:chinnamarlaashok@gmail.com)
""")
